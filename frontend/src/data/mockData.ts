...
export const mockQuizzes: Quiz[] = [
  { id: 'quiz-1', course_id: 'course-1', title: 'React Fundamentals Quiz', description: 'Test your knowledge of React basics', passing_percentage: 70, timer_minutes: 30, attempt_limit: 3, created_at: '2024-06-05T10:00:00Z', course_title: 'Complete React Developer Course 2025', question_count: 5 },
  { id: 'quiz-2', course_id: 'course-1', title: 'Hooks Mastery Quiz', description: 'Advanced hooks questions', passing_percentage: 75, timer_minutes: 45, attempt_limit: 2, created_at: '2024-06-10T10:00:00Z', course_title: 'Complete React Developer Course 2025', question_count: 3 },
  { id: 'quiz-3', course_id: 'course-2', title: 'Express & REST API Quiz', description: 'Test your API knowledge', passing_percentage: 65, timer_minutes: 30, attempt_limit: 3, created_at: '2024-07-05T10:00:00Z', course_title: 'Node.js & Express REST API Masterclass', question_count: 4 },
];

export const mockQuestions: Question[] = [
  { id: 'q-1', quiz_id: 'quiz-1', question_text: 'What is JSX?', question_type: 'MCQ', display_order: 1, created_at: '2024-06-05T10:00:00Z' },
  { id: 'q-2', quiz_id: 'quiz-1', question_text: 'Which hook is used for side effects?', question_type: 'MCQ', display_order: 2, created_at: '2024-06-05T10:00:00Z' },
  { id: 'q-3', quiz_id: 'quiz-1', question_text: 'Which of the following are React hooks?', question_type: 'MULTIPLE_CORRECT', display_order: 3, created_at: '2024-06-05T10:00:00Z' },
  { id: 'q-4', quiz_id: 'quiz-1', question_text: 'What does useState return?', question_type: 'MCQ', display_order: 4, created_at: '2024-06-05T10:00:00Z' },
  { id: 'q-5', quiz_id: 'quiz-1', question_text: 'How do you pass data from parent to child?', question_type: 'MCQ', display_order: 5, created_at: '2024-06-05T10:00:00Z' },
  { id: 'q-6', quiz_id: 'quiz-2', question_text: 'When does useEffect run by default?', question_type: 'MCQ', display_order: 1, created_at: '2024-06-10T10:00:00Z' },
  { id: 'q-7', quiz_id: 'quiz-2', question_text: 'Which hooks are used for performance optimization?', question_type: 'MULTIPLE_CORRECT', display_order: 2, created_at: '2024-06-10T10:00:00Z' },
  { id: 'q-8', quiz_id: 'quiz-2', question_text: 'What is the purpose of useReducer?', question_type: 'MCQ', display_order: 3, created_at: '2024-06-10T10:00:00Z' },
];

export const mockQuestionOptions: QuestionOption[] = [
  { id: 'opt-1', question_id: 'q-1', option_text: 'A JavaScript syntax extension', is_correct: true, display_order: 1 },
  { id: 'opt-2', question_id: 'q-1', option_text: 'A new programming language', is_correct: false, display_order: 2 },
  { id: 'opt-3', question_id: 'q-1', option_text: 'A CSS framework', is_correct: false, display_order: 3 },
  { id: 'opt-4', question_id: 'q-1', option_text: 'A database query language', is_correct: false, display_order: 4 },
  { id: 'opt-5', question_id: 'q-2', option_text: 'useState', is_correct: false, display_order: 1 },
  { id: 'opt-6', question_id: 'q-2', option_text: 'useEffect', is_correct: true, display_order: 2 },
  { id: 'opt-7', question_id: 'q-2', option_text: 'useContext', is_correct: false, display_order: 3 },
  { id: 'opt-8', question_id: 'q-3', option_text: 'useState', is_correct: true, display_order: 1 },
  { id: 'opt-9', question_id: 'q-3', option_text: 'useEffect', is_correct: true, display_order: 2 },
  { id: 'opt-10', question_id: 'q-3', option_text: 'useRouter', is_correct: false, display_order: 3 },
  { id: 'opt-11', question_id: 'q-3', option_text: 'useFetch', is_correct: false, display_order: 4 },
  { id: 'opt-12', question_id: 'q-4', option_text: 'A state value and a setter function', is_correct: true, display_order: 1 },
  { id: 'opt-13', question_id: 'q-4', option_text: 'Only a state value', is_correct: false, display_order: 2 },
  { id: 'opt-14', question_id: 'q-4', option_text: 'Only a setter function', is_correct: false, display_order: 3 },
  { id: 'opt-15', question_id: 'q-5', option_text: 'Using props', is_correct: true, display_order: 1 },
  { id: 'opt-16', question_id: 'q-5', option_text: 'Using state', is_correct: false, display_order: 2 },
  { id: 'opt-17', question_id: 'q-5', option_text: 'Using context', is_correct: false, display_order: 3 },
  { id: 'opt-18', question_id: 'q-6', option_text: 'After every render', is_correct: true, display_order: 1 },
  { id: 'opt-19', question_id: 'q-6', option_text: 'Only on mount', is_correct: false, display_order: 2 },
  { id: 'opt-20', question_id: 'q-7', option_text: 'useMemo', is_correct: true, display_order: 1 },
  { id: 'opt-21', question_id: 'q-7', option_text: 'useCallback', is_correct: true, display_order: 2 },
  { id: 'opt-22', question_id: 'q-7', option_text: 'useState', is_correct: false, display_order: 3 },
  { id: 'opt-23', question_id: 'q-8', option_text: 'Manage complex state logic', is_correct: true, display_order: 1 },
  { id: 'opt-24', question_id: 'q-8', option_text: 'Fetch data from APIs', is_correct: false, display_order: 2 },
];
