...
const navItems: NavItem[] = [
  { to: '/student/courses', label: 'Browse Courses', icon: <Compass className="h-5 w-5" />, end: true },
                ...
                <>
                  ...
                  <div className="absolute right-0 z-20 mt-2 w-80 rounded-xl border border-gray-200 bg-white shadow-lg">
                    ...
                    <div className="max-h-80 overflow-y-auto">
                      {notifications?.map((n) => (
                        <div key={n.id} className={classNames('border-b border-gray-50 px-4 py-3', !n.read && 'bg-emerald-50/50')}>
